...
echo " 2. CPU 하이브리드 토폴로지 최적화 (E-코어 8개 전담 + CPU 0 식물인간 격리)"
echo "    - P코어 차단 (CPU 1~7 OFF, 하드웨어 오프라인)"
echo "    - CPU 0 식물인간 격리 (x86 BSP 제약으로 상주하되 cgroups AllowedCPUs=8-15로 작업 완전 배제 -> C10 딥슬립)"
