...
echo " (oled_contrast: 화이트포인트 감소 85~90% & 블랙 리프트 +2.0~4.0%)"
echo "========================================================="
...
echo "    - oled_medium_contrast.icc: 블랙 +4.0%, 화이트 85.0% (강한 대비 완화)"
...
echo "    - oled-mode medium : 더 부드러운 대비 완화 (블랙 +4.0%, 화이트 85%)"
