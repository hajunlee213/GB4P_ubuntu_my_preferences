...
for f in oled_high_contrast.icc oled_high_pure_black.icc oled_medium_contrast.icc oled_medium_pure_black.icc oled_gentle_contrast.icc oled_pure_black.icc oled_custom.icc; do
